...
public class StartWindow extends JFrame implements MouseListener {
	...
	public StartWindow() throws IOException, UnexpectedException {
		super();
		this.setSize(new Dimension(1280, 700));
		this.setContentPane(new JLabel(new ImageIcon("/HS-M2/Images/StartWindowGame.jpg")));
		Cursor cursor = Toolkit.getDefaultToolkit().createCustomCursor(
				(new ImageIcon("/HS-M2/other/normalCursor.png")).getImage(), new Point(), "Normal Cursor");
		this.setCursor(cursor);
		this.setLayout(new FlowLayout(FlowLayout.LEFT, 450, 500));
		setDefaultCloseOperation(EXIT_ON_CLOSE);
		JLabel startGame = new JLabel("Start Game", JLabel.CENTER);
		startGame.setForeground(Color.BLUE);
		startGame.setFont(new Font("Georgia", Font.BOLD, 50));
