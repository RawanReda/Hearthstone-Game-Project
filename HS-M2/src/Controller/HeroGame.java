...
public Hero hero;
	public HeroGame(Hero a) throws MalformedURLException, IOException {
		hero=a;
...
System.out.println("dwdwd"+name);
		...
		BufferedImage image1 = resize(x,Manacost, TManacost, Health);
...
public static String getImageName(String name) {
	...
	if (name.equals("Rexxar"))
		imagename = "/HS-M2/Images/Hunter.png";
	else if (name.equals("Jaina Proudmoore"))
		imagename = "/HS-M2/Images/Mage.png";
	else if (name.equals("Uther Lightbringer"))
		imagename = "/HS-M2/Images/Paladin.png";
	else if (name.equals("Anduin Wrynn"))
		imagename = "/HS-M2/Images/Priest.png";
...
public void setHero(Hero hero) {
	...
	public static BufferedImage resize(ImageIcon x,int mana, int tmana, int health) {

		BufferedImage image = new BufferedImage(200, 200, BufferedImage.TYPE_INT_ARGB_PRE);
		...
		g2d.setFont(g.getFont().deriveFont(40f));
			 ...
			 g2d.drawString(String.valueOf(health), 150, 170);
		     g2d.drawString(String.valueOf(mana)+"/"+ String.valueOf(tmana), 10, 160);
